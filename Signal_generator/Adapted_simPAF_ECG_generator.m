...
switch onlyRR
    ...
    case 0 % multilead ECG is generated
        ...
        multileadAA = Adapted_simPAF_gen_multilead_AA(targets_SR_AF, targets_APB, QRSindex, fibFreqz, realAAon, ecgLength, AFburden, DATAfWaves);
        % Generate multilead noise
        multileadNoise = Adapted_simPAF_gen_noise(ecgLength, noiseType, noiseRMS, DATAnoises);
        % Generate multilead noise
